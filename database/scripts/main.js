...
var loginnameInput = document.getElementById('new-login-name');
 ...
 */
// [START write_fan_out]
function writeNewPost(uid, username, picture, title, body, loginname) {
  // A post entry.
  var postData = {
    author: username,
    uid: uid,
 ...
 */
function createPostElement(postId, title, text, author, authorId, authorPic, loginname) {
 ...
 */
function newPostForCurrentUser(title, text, login) {
...
window.addEventListener('load', function() {
  ...
  messageForm.onsubmit = function(e) {
    ...
    var login = loginnameInput.value;
    console.log(login);
    if (text && title && login) {
      newPostForCurrentUser(title, text, login).then(function() {
